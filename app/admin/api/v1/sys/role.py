...
@router.get(
    "/{pk}/all", summary="Get all roles of a user", dependencies=[DependsJwtAuth]
)
...
@router.get(
    "/{pk}/menus", summary="Get all character menus", dependencies=[DependsJwtAuth]
)
...
@router.get(
    "/{pk}/rules",
    summary="Get all data rules of the role",
    dependencies=[DependsJwtAuth],
)
async def get_role_all_rules(
    pk: Annotated[int, Path(description="role ID")]
...
async def update_role(
    pk: Annotated[int, Path(description="role ID")], obj: UpdateRoleParam
) -> ResponseModel:
...
async def delete_role(
    pk: Annotated[list[int], Query(description="role ID list")]
) -> ResponseModel:
