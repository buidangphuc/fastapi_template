...
@router.post('/login/swagger', summary='swagger login', description='Used to quickly obtain token for swagger authentication')
...
@router.post('/token/new', summary='Create new token', description='Create a new token, the old token will be invalidated')
