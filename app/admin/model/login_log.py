...
class LoginLog(DataClassBase):
    ...
    status: Mapped[int] = mapped_column(insert_default=0, comment='Login status (0: success, 1: failure)')
    ...
    msg: Mapped[str] = mapped_column(LONGTEXT().with_variant(TEXT, 'postgresql'), comment='login message')
