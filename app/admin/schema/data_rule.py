...
class DataRuleSchemaBase(SchemaBase):
    ...
    operator: RoleDataRuleOperatorType = Field(RoleDataRuleOperatorType.OR, description='Operator (OR, AND)')
    expression: RoleDataRuleExpressionType = Field(RoleDataRuleExpressionType.eq, description='rule expression type')
