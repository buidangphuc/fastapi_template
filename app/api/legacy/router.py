...
# Experimental streaming variant: POST /api/v1/description/pair_address/stream
# (+ /demo page). Separate endpoint; bypasses quota + structured output.
router.include_router(
    pair_address_stream.router, prefix="/description", tags=["Generator"]
)
